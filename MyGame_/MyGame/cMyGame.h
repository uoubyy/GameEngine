...
namespace eae6320
{
	...
	private:
		...
		{
			return "Yanyi Bao's EAE6320 Game"
				" -- "
		...
		const char* GetMainWindowClassName() const final { return "Yanyi Bao's EAE6320 Game Main Window Class"; }
		...
		const WORD* GetLargeIconId() const final { static constexpr WORD iconId_large = IDI_UTAH_LARGE; return &iconId_large; }
		const WORD* GetSmallIconId() const final { static constexpr WORD iconId_small = IDI_UTAH_SMALL; return &iconId_small; }
#endif
